...
$I->fillField('#title',"Admin ad basecamp_free theme");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','57');
$I->fillField('#description','This is a new admin ad on basecamp free theme');
...
$I->amOnPage('/apartment/admin-ad-basecamp-free-theme.html');
$I->see('Admin ad basecamp_free theme');
$I->see('This is a new admin ad on basecamp free theme');
$I->see('Barcelona');
