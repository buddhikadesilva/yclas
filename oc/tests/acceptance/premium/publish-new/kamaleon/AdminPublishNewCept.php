...
$I->fillField('#title',"Admin ad kamaleon theme");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','57');
$I->fillField('#description','This is a new admin ad on kamaleon theme');
...
$I->amOnPage('/apartment/admin-ad-kamaleon-theme.html');
$I->see('Admin ad kamaleon theme');
$I->see('This is a new admin ad on kamaleon theme');
$I->see('Barcelona');
