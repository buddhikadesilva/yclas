...
$I->fillField('#title',"User ad on kamaleon");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new user ad on kamaleon theme');
...
$I->amOnPage('/apartment/user-ad-on-kamaleon.html');
$I->see('User ad on kamaleon');
$I->see('This is a new user ad on kamaleon theme');
$I->see('Barcelona');
