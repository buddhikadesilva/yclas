...
$I->fillField('#title','New ad unregister olson');
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new ad from unregister user on the olson theme');
...
$I->amOnPage('/apartment/new-ad-unregister-olson.html');
$I->see('New ad unregister olson');
$I->see('This is a new ad from unregister user on the olson theme');
$I->see('Barcelona');
