...
$I->fillField('#title',"User ad on czsale");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new user ad on czsale theme');
...
$I->amOnPage('/apartment/user-ad-on-czsale.html');
$I->see('User ad on czsale');
$I->see('This is a new user ad on czsale theme');
$I->see('Barcelona');
