...
$I->fillField('#title',"Admin ad czsale theme");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','57');
$I->fillField('#description','This is a new admin ad on czsale theme');
...
$I->amOnPage('/apartment/admin-ad-czsale-theme.html');
$I->see('Admin ad czsale theme');
$I->see('This is a new admin ad on czsale theme');
$I->see('Barcelona');
