...
$I->fillField('#title',"User ad on default");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new user ad on default theme');
...
$I->amOnPage('/apartment/user-ad-on-default.html');
$I->see('User ad on default','h1');
$I->see('25.00','span');
$I->see('Phone: 99885522','a');
$I->see('This is a new user ad on default theme');
$I->see('Barcelona');
