...
$I->fillField('#title','New ad unregister basecamp');
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new ad from unregister user on the basecamp theme');
...
$I->amOnPage('/apartment/new-ad-unregister-basecamp.html');
$I->see('New ad unregister basecamp');
$I->see('This is a new ad from unregister user on the basecamp theme');
$I->see('Barcelona');
