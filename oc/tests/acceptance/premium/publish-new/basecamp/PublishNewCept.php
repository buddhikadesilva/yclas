...
$I->fillField('#title',"User ad on basecamp");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new user ad on basecamp theme');
...
$I->amOnPage('/apartment/user-ad-on-basecamp.html');
$I->see('User ad on basecamp');
$I->see('This is a new user ad on basecamp theme');
$I->see('Barcelona');
