...
$I->fillField('#title','New ad unregister pinclass');
...
$I->amOnPage('/apartment/new-ad-unregister-pinclass.html');
$I->see('New ad unregister pinclass');
$I->see('This is a new ad from unregister user on the pinclass theme');
$I->see('Barcelona');
