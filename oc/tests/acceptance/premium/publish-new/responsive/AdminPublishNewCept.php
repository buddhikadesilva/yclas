...
$I->fillField('#title',"Admin ad responsive theme");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','57');
$I->fillField('#description','This is a new admin ad on responsive theme');
...
$I->amOnPage('/apartment/admin-ad-responsive-theme.html');
$I->see('Admin ad responsive theme');
$I->see('This is a new admin ad on responsive theme');
$I->see('Barcelona');
