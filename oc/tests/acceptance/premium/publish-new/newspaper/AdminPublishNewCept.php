...
$I->fillField('#title',"Admin ad newspaper theme");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','57');
$I->fillField('#description','This is a new admin ad on newspaper theme');
...
$I->amOnPage('/apartment/admin-ad-newspaper-theme.html');
$I->see('Admin ad newspaper theme');
$I->see('This is a new admin ad on newspaper theme');
$I->see('Barcelona');
