...
$I->fillField('#title','New ad unregister moderndeluxe');
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new ad from unregister user on the moderndeluxe theme');
...
$I->amOnPage('/apartment/new-ad-unregister-moderndeluxe.html');
$I->see('New ad unregister moderndeluxe');
$I->see('This is a new ad from unregister user on the moderndeluxe theme');
$I->see('Barcelona');
