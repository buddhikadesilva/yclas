...
$I->fillField('#title',"User ad on ocean");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new user ad on ocean theme');
...
$I->amOnPage('/apartment/user-ad-on-ocean.html');
$I->see('User ad on ocean');
$I->see('This is a new user ad on ocean theme');
$I->see('Barcelona');
