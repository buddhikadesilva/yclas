...
$I->fillField('#title','New ad unregister ocean');
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new ad from unregister user on the ocean theme');
...
$I->amOnPage('/apartment/new-ad-unregister-ocean.html');
$I->see('New ad unregister ocean');
$I->see('This is a new ad from unregister user on the ocean theme');
$I->see('Barcelona');
