...
$I->fillField('#title','New ad unregister basecamp free');
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new ad from unregister user on the basecamp_free theme');
...
$I->amOnPage('/apartment/new-ad-unregister-basecamp-free.html');
$I->see('New ad unregister basecamp free');
$I->see('This is a new ad from unregister user on the basecamp_free theme');
$I->see('Barcelona');
