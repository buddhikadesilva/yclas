...
$I->fillField('#title','New ad unregister splash');
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new ad from unregister user on the splash theme');
...
$I->amOnPage('/apartment/new-ad-unregister-splash.html');
$I->see('New ad unregister splash');
$I->see('This is a new ad from unregister user on the splash theme');
$I->see('Barcelona');
