...
$I->fillField('#title',"User ad on splash");
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new user ad on splash theme');
...
$I->amOnPage('/apartment/user-ad-on-splash.html');
$I->see('User ad on splash');
$I->see('This is a new user ad on splash theme');
$I->see('Barcelona');
