...
$I->fillField('#title',"Admin ad jobdrop theme");
...
$I->amOnPage('/apartment/admin-ad-jobdrop-theme.html');
$I->see('Admin ad jobdrop theme');
$I->see('This is a new admin ad on jobdrop theme');
$I->see('Barcelona');
