...
$I->fillField('#title','New ad unregister reclassifieds');
$I->click('.select-category');
$I->fillField('category','18');
$I->fillField('location','4');
$I->fillField('#description','This is a new ad from unregister user on the reclassifieds theme');
...
$I->amOnPage('/apartment/new-ad-unregister-reclassifieds.html');
$I->see('New ad unregister reclassifieds');
$I->see('This is a new ad from unregister user on the reclassifieds theme');
$I->see('Barcelona');
